...
export class MercadocapComponent implements OnInit {
  ...
  constructor(private validators: ValidatorsService, private service: MercadocapService, private notify: NotifyService) {
    this.roles = [];
    //this.columns = [ 'id','nome','linha_cap','mercado_cap', 'actions' ]
    this.columns = [ 'mercadocapid', 'mercadocap', 'actions' ]
