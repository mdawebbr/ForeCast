...
export class LinhacapService {
  ...
  GetById(id: number) {
    //debugger
    return this.http.get(`${environment.apiUrl}/api/LinhaCAP/GetById?id=${id}`);
  }

  getLinhacap() {
    return this.http.get(`${environment.apiUrl}/api/LinhaCAP/GetLinhaCAP`);
  }
  ...
  GetAllMeioTransporte() {
    return this.http.get(`${environment.apiUrl}/api/LinhaCAP/GetAllMeioTransporte`);
  }

  PostCliente(obj)
  {
    return this.http.post(`${environment.apiUrl}/api/LinhaCAP/`, obj);
  }

  UpdateLCAP(obj)
  {
    return this.http.post(`${environment.apiUrl}/api/LinhaCAP/Alterar`, obj);
  }

  RemoverCliente(obj)
  {
    return this.http.post(`${environment.apiUrl}/api/LinhaCAP/Remover`, obj);
  }
